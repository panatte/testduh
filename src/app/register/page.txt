      ...
      <div style={{ paddingLeft: "17.5%", paddingRight: "17.5%" }}>
        <div className="px-5 py-5" style={{ minHeight: "calc(100vh - 185px)" }}>
          ...
          <div className="flex flex-col items-center mt-4">
            <Link href="/"><button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" style={{ width: "320px"}}>Register</button></Link>
            <div className="text-left mt-2 text-sm text-blue-700 hover:text-blue-800" ><Link href="/login">Already have an account?</Link></div>
          </div>
        </div>
      </div>
      <Footer />
